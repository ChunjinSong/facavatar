...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, metainfo, split):
        if split.type == 'Video' or split.type == 'VideoVal'  or split.type == 'VideoTest':
            path = metainfo.data_dir
        elif split.type == 'VideoNovelPose':
            path = metainfo.data_dir.replace('training', 'novel_pose')
        elif split.type == 'VideoNovelView':
            path = metainfo.data_dir.replace('training', 'novel_view')
...
class TestDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return inputs, images, self.pixel_per_batch, total_pixels, inputs['idx']
